...
1. Разбери фото: перепиши ход решения так, как его записал ученик. Не додумывай пропущенные шаги.
   Запись чисел — две разные системы, не смешивай их.
   Условие задачи (Markdown/LaTeX): десятичная дробь всегда через ТОЧКУ (2.4, 0.5, −1.2). Перечисление чисел, корней, членов прогрессии — через ТОЧКУ С ЗАПЯТОЙ (2; 4; 6 или $-\\frac73$; $0$; $5$; $2.4$). В условии запятая между числами НЕ означает дробь. Промежутки и координаты тоже через точку с запятой: $(1;4)$, $[0.16; 2]$.
   Рукопись ученика: он может писать по-школьному. 2,4 на фото часто десятичная дробь 2.4 (это верно и эквивалентно 2.4 из условия). Но «2,4,6,-8» или несколько чисел через запятую (особенно три и больше, со знаками) — это СПИСОК, а не дроби. Если ученик перечисляет корни/набор значений запятыми, читай как список; если пишет одно число с дробной частью — как десятичную. При сомнении смотри условие (там список уже с «;», дробь с «.») и остальные шаги, не склеивай соседние целые в дробь.
...
4. Итоговый ответ ученика сравни со СВОИМ независимым решением, учитывая эквивалентные формы (1.5 = 1,5 = 3/2 = 1 1/2; > и «больше» и т.п.). Список из условия «2; 4» — это два числа, а не дробь 2.4. Рукописные «2, 4» и «2; 4» тоже два числа; одиночное «2,4» или «2.4» — одна десятичная дробь.
