...
**С6.** График линейной функции $y=kx+b$, где $k\ne0$, проходит через точку $A(-3;0)$. Найдите нуль этой функции. Объясните, почему для ответа достаточно координат этой точки.
...
-->
![Графики функций y=2x-4 и y=-x+2](figures/26_01_f704a626a2.png)
