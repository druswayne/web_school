...
**С4.** Прямая $2x+by=18$ проходит через точку $P(3;2)$. Найдите коэффициент $b$ и координаты точки пересечения этой прямой с осью ординат.
...
**С18.** При каком значении параметра $m$ график уравнения $(m-2)x+3y=6$ проходит через точку $P(2;-1)$? Запишите полученное уравнение прямой и определите, пересекает ли она обе координатные оси.
