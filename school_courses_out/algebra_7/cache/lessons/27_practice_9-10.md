...
**С11.** Графики трёх функций имеют вид $y=2x+b_1$, $y=2x+b_2$ и $y=2x+b_3$. Известно, что при $x=5$ значения этих функций соответственно равны $-1$, $5$ и $11$. Найдите $b_1$, $b_2$, $b_3$ и запишите все три функции.
...
**С14.** Прямая $y=(2a-1)x+6$ параллельна прямой $y=7x-b$. Прямая $y=7x-b$ проходит через точку $A(-2;5)$. Найдите значения $a$ и $b$.
