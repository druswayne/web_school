...
**С11.** Угол $MON$ равен $84^\circ$. Луч $OP$ делит его на два угла так, что $\angle MOP$ в $2$ раза больше $\angle PON$. Найдите величину угла $\angle MOP$.
...
**С35.** Угол $MON$ равен $64^\\circ$. Луч $OK$ является его биссектрисой. Выберите верное утверждение: 1) $\\angle MOK=16^\\circ$; 2) $\\angle MOK=24^\\circ$; 3) $\\angle MOK=32^\\circ$; 4) $\\angle MOK=64^\\circ$; 5) $\\angle MOK=128^\\circ$.

**С36.** Угол $YXZ$ равен $150^\\circ$. Луч $XT$ проходит внутри этого угла, причём $\\angle YXT$ на $20^\\circ$ больше $\\angle TXZ$. Найдите $\\angle YXT$.
