...
а) ломаная $ABCD$, в которой $A$, $B$, $C$, $D$ — различные точки, звено $DA$ отсутствует, а звенья $AB$, $BC$ и $CD$ не имеют самопересечений;
...
**С8.** Дана пятизвенная незамкнутая ломаная $ABCDEF$, длина первого звена которой равна $3$ см. Каждое следующее звено в $2$ раза длиннее предыдущего. Найдите длину всей ломаной и длину её наибольшего звена.
...
**С11.** На плоскости отмечены пять точек, никакие три из которых не лежат на одной прямой. Через каждую пару точек проведён отрезок. Сколько всего таких отрезков?

**С12.** В кубе $ABCDM NPK$ вершины граней $ABCD$ и $MNPK$ соединены рёбрами $AM$, $BN$, $CP$ и $DK$. Точки $E$ и $G$ лежат соответственно внутри рёбер $MK$ и $KD$, причём $E$ и $G$ различны. Рассматриваются бесконечные прямые. Из прямых $AD$, $MN$, $AM$, $NP$, $BC$ и $DC$ выпишите те, которые пересекает прямая $EG$. Затем запишите все простые ломаные с концами в точках $A$ и $P$, звеньями которых являются рёбра куба.
...
**С24.** На отрезке $AB$ отмечены точки $M$ и $K$ в порядке $A$–$M$–$K$–$B$. Известно, что $AM=14$ см, $MK=18$ см, а расстояние между серединами отрезков $AM$ и $KB$ равно $26$ см. Найдите длину отрезка $AB$.
