...
**С33.** Согласно аксиоме о прямой через две точки, сколько прямых можно провести через две различные точки $M$ и $N$?

1) одну; 2) две; 3) ни одной; 4) бесконечно много; 5) это зависит от длины отрезка $MN$.
