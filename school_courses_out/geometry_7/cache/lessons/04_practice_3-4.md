**С1.** Отметьте точки $A$, $B$, $C$, не лежащие на одной прямой. Запишите все прямые, которые можно провести через пары этих точек, и лучи, проходящие через точку $A$ и одну из точек $B$ или $C$.
