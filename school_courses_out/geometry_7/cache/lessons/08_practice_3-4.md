...
**С22.** Прямые $p$ и $r$ обе перпендикулярны прямой $q$. Как расположены прямые $p$ и $r$ относительно друг друга?
...
**С24.** Прямая $k$ перпендикулярна прямой $l$. Прямая $m$ проходит через точку, не лежащую на прямых $l$ и $k$, и перпендикулярна прямой $l$. Как расположены прямые $k$ и $m$?
