...
**С3.** На окружности с центром $O$ точки $A$ и $B$ являются концами диаметра, а точка $C$ лежит на одной из полуокружностей $AB$. Сколько дуг получается при разбиении окружности точками $A$, $B$ и $C$? Сколько среди отрезков $AB$, $AC$ и $BC$ хорд? Сколько среди них диаметров? Сколько полуокружностей имеет окружность с диаметром $AB$? Ответ представьте четырьмя числами в указанном порядке.

**С4.** Диаметр первого колеса равен $64$ см, а диаметр второго колеса равен $50$ см. Найдите радиусы обоих колёс, разность их радиусов и сумму их диаметров.
...
**С7.** Две окружности имеют общий центр $O$ и радиусы $6$ см и $10$ см. Назовите эти окружности. Найдите ширину кольца между ними и сумму их диаметров.

**С8.** Две окружности имеют общий центр $O$ и радиусы $7$ см и $12$ см. Назовите эти окружности. Найдите ширину кольца между ними и сумму их диаметров.
