...
**С3.** Через точку $P$, лежащую на прямой $c$, провели прямую $p$, перпендикулярную прямой $c$. Затем через точку $Q$, не лежащую на прямой $c$ и не лежащую на прямой $p$, провели прямую $q$, перпендикулярную прямой $c$. Определите взаимное расположение прямых $p$ и $q$ и обоснуйте ответ.
...
-->
![Прямые a и c, перпендикулярные в точке C](figures/08_01_a8edbfe6a0.png)
...
-->
![Перпендикулярные прямые a и b](figures/08_02_bd34955fde.png)

*Перпендикулярные прямые a и b*



**С9.** На плоскости даны прямая $a$ и точки $A$, $B$, $C$, не лежащие на ней. Через каждую из этих точек проведена прямая, перпендикулярная прямой $a$. Прямые, проведённые через точки $A$ и $B$, совпали. Известно, что точка $C$ не лежит на этой совпавшей прямой. Может ли прямая, проведённая через точку $C$, пересекать совпавшую прямую? Ответ обоснуйте.
...
-->
![Перпендикуляры AB и CD к прямой a](figures/08_03_df6cbc5a4e.png)
...
**С19.** Прямые $a$ и $b$ пересекаются в точке $O$ под прямым углом. Точка $M$ лежит на луче прямой $b$ и не совпадает с $O$. Через точку $M$ проведён перпендикуляр $MK$ к прямой $a$, где $K$ — точка пересечения этого перпендикуляра с прямой $a$. На какой прямой лежит точка $K$? Обоснуйте ответ.
...
**С22.** Даны прямая $a$ и точка $P$, не лежащая на ней. Через точку $P$ проведена прямая $b$, перпендикулярная прямой $a$, а $H$ — точка их пересечения. Объясните, почему такая прямая $b$ единственна и почему точка $H$ является основанием перпендикуляра из $P$ к прямой $a$.

**С23.** Даны прямая $a$ и точка $B$, лежащая на ней. Прямая $b$ проходит через точку $B$ и перпендикулярна прямой $a$. Объясните, почему такая прямая $b$ единственна.
