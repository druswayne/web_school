...
**С14.** Даны точки $A$, $B$, $C$, $D$, расположенные на одной прямой именно в порядке $A$, $B$, $C$, $D$. Определите для каждой пары отрезков $AC$ и $BD$, $AB$ и $CD$, $AD$ и $BC$, $AB$ и $BC$ множество их общих точек. Если общих точек нет, укажите это.
