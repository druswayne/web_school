...
**С8.** Точка $R$ лежит на прямой $p$. Через точку $R$ провели перпендикуляр $RS$ к прямой $p$. Как называется перпендикуляр $RS$: опущенным или восстановленным к прямой $p$?
