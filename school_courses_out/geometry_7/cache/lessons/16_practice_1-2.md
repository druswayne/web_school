...
**С12.** В четырёхугольнике $ABCD$ известно, что $AB=BC$ и $AD=DC$. Докажите, что диагонали $AC$ и $BD$ перпендикулярны.
...
**С32.** Точка $K$ — середина отрезка $AB$, а прямая $MK$ перпендикулярна отрезку $AB$. Известно, что $\angle AMB=84^\circ$. Найдите $\angle BMK$.
