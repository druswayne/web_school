...
**С19.** В треугольниках $ABC$ и $DEF$ известно: $AB=DE$, $BC=EF$, $AC=DF$. Какой вывод следует из третьего признака?
...
**С20.** С20. Для доказательства равенства треугольников \(ABC\) и \(DEF\) по третьему признаку даны условия:
