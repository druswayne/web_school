**С1.** В простой замкнутой ломаной $ABCD$ диагональ $AC$ разделяет её на треугольники $ABC$ и $CDA$. Известно, что $AB=AD$ и $BC=CD$. Докажите, что $AC$ является биссектрисой углов $BAD$ и $BCD$, а углы $ABC$ и $CDA$ равны.
...
**С14.** В выпуклом четырёхугольнике $ABCD$ диагональ $BD$ проведена. Выполнены равенства $AB=CD$ и $BC=AD$. Известно, что $\angle BAD=84^\circ$ и $\angle ABC=96^\circ$. Найдите величины всех углов четырёхугольника и обоснуйте результат, используя третий признак равенства треугольников.
