...
**С12.** На плоскости даны прямая \(a\) и различные точки \(M\), \(N\), не лежащие на ней. Через точки \(M\) и \(N\) проведены прямые \(b\) и \(c\), перпендикулярные прямой \(a\). Известно, что прямая \(MN\) не перпендикулярна прямой \(a\). Докажите, что прямые \(b\) и \(c\) различны и параллельны.

**С13.** Прямые \(a\) и \(b\) пересекаются в точке \(O\) под прямым углом. На прямой \(a\) выбраны точки \(A\) и \(C\), расположенные по разные стороны от точки \(O\), а на прямой \(b\) — точки \(B\) и \(D\), также расположенные по разные стороны от точки \(O\). Укажите пары отрезков с концами в точках \(A\), \(B\), \(C\), \(D\), которые обязательно перпендикулярны друг другу при любом выборе этих точек.

**С14.** Прямая \(a\) проходит через точки \(B\) и \(C\). Точки \(A\) и \(D\) не лежат на прямой \(a\). Из точки \(A\) проведён перпендикуляр \(AB\) к прямой \(a\), а из точки \(C\) проведён перпендикуляр \(CD\) к прямой \(a\). Докажите, что прямые \(AB\) и \(CD\) параллельны. Объясните, почему отрезок \(AB\) является перпендикуляром, опущенным из точки \(A\), а отрезок \(CD\) — перпендикуляром, восстановленным к прямой \(a\).

**С15.** На прямой \(m\) выбраны попарно различные точки \(K\), \(L\) и \(N\). Через точку \(K\) проведена прямая \(p\), перпендикулярная прямой \(m\), через точку \(L\) — прямая \(q\), также перпендикулярная прямой \(m\), а через точку \(N\) — прямая \(r\), перпендикулярная прямой \(m\). Определите взаимное расположение прямых \(p\), \(q\) и \(r\). Ответ обоснуйте, используя теорему о двух прямых, перпендикулярных третьей.
