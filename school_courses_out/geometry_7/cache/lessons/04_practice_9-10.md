**С1.** На прямой в указанном порядке расположены точки $A$, $M$, $K$, $B$. Известно, что $AB=54$ см, $MK=18$ см, расстояние между серединами отрезков $AM$ и $KB$ равно $36$ см, а $AM$ в 2 раза больше $KB$. Найдите длины отрезков $AM$ и $KB$.
...
**С10.** Простая замкнутая ломаная $ABCDEF$ образует многоугольник. Точки $M$, $N$ и $K$ — середины сторон $AB$, $CD$ и $EF$ соответственно. Найдите длину ломаной $ABCDEF$, если $MB+NC+KF=27$ см, $AM+DN+KE=33$ см, а $BC+DE+FA=24$ см.

**С11.** На плоскости отмечены пять точек, никакие три из которых не лежат на одной прямой. Из каждой точки проведены отрезки ко всем остальным точкам. Сколько всего получилось отрезков?

**С12.** На прямой расположены точки $A$, $B$, $C$, $D$, $E$ в указанном порядке. Известно, что $AC=28$ см, $BD=32$ см, $CE=54$ см, $AB=BC$, а $DE=2CD$. Найдите длину отрезка $AE$ и расстояние между серединами отрезков $AC$ и $DE$.
