...
**С7.** В окружности с центром $O$ хорды $AB$ и $BC$ равны. Точки $E$ и $F$ — середины хорд $AB$ и $BC$ соответственно. Известно, что $OE=6$ см и $EF=5$ см. Докажите равенство треугольников $OEA$ и $OFC$, а затем найдите периметр треугольника $EOF$.
...
**С14.** Отрезок $AB$ имеет длину $12$ см. По одну сторону от прямой $AB$ расположены точки $M$ и $K$, причём $AM=BK=9$ см и $BM=AK=7$ см. Докажите, что треугольники $AMB$ и $BKA$ равны по трём сторонам.
...
**С21.** В треугольнике \(BCD\) точка \(M\) лежит на стороне \(BC\), причём \(BM=CM\). Докажите, что \(DM\perp BC\), если \(BD=CD\).
...
**С23.** В квадрате \(ABCD\) проведена диагональ \(AC\). Докажите равенство треугольников \(ABC\) и \(ADC\).
