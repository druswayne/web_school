...
**С7.** Два луча разделяют развернутый угол на два угла. Один из получившихся углов равен $72^\circ$. Найдите величину другого угла и определите вид каждого из двух углов.
...
**С9.** Прямые $a$ и $b$ не пересекаются, а прямая $c$ пересекает каждую из них. Верно ли, что прямые $a$ и $b$ параллельны? Ответ обоснуйте определением параллельных прямых.
...
**С12.** На плоскости проведены три различные прямые $a$, $b$ и $c$. Прямые $a$ и $c$ не пересекаются, а прямые $a$ и $c$ перпендикулярны прямой $b$. Как называются прямые $a$ и $c$? Ответ обоснуйте определением параллельных прямых.
...
**С15.** Прямые $a$ и $c$ пересекаются в точке $M$. Один из углов, образованных этими прямыми, равен $128^\circ$. Этот угол и каждый из двух углов, смежных с ним, образуют развернутый угол. Найдите величины двух углов, смежных с данным.
