...
**С13.** На отрезке $AB$ отмечена точка $C$, причём $AC=7$ см, $CB=5$ см. Найдите длину отрезка $AB$.
...
**С20.** На рисунке изображены точки \(A\), \(B\), \(C\) и \(D\). Луч \(BC\) лежит внутри угла \(ABD\). Лучи \(BA\) и \(BC\) образуют угол \(ABC\), равный \(35^\circ\), а лучи \(BC\) и \(BD\) образуют угол \(CBD\), равный \(25^\circ\). Найдите величину угла \(ABD\).
...
-->
![Круг с центром O](figures/01_01_ab7022286a.png)
...
-->
![Перпендикулярные прямые a и BC](figures/01_02_5981bf56b5.png)

*Перпендикулярные прямые a и BC*
...
**С29.** Прямые $m$ и $n$ пересекаются под прямым углом. Прямая $p$ параллельна прямой $m$ и пересекает прямую $n$ в точке $P$ под прямым углом. Укажите вид углов, образованных прямыми $p$ и $n$.
