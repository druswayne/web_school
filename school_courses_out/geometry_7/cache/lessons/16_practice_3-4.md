...
**С7.** Точка $M$ лежит на серединном перпендикуляре к отрезку $AB$. Известно, что $MA=13$ см. Найдите длину отрезка $MB$.
...
**С12.** На одной стороне от прямой \(a\) расположены точки \(A\) и \(B\), не лежащие на этой прямой. Известно, что прямая \(a\) пересекает серединный перпендикуляр к отрезку \(AB\) в точке \(M\). Докажите, что \(M\) — единственная точка прямой \(a\), равноудалённая от точек \(A\) и \(B\).
...
**С18.** Точка \(K\) лежит на серединном перпендикуляре к отрезку \(MN\). Известно, что \(NK=15\) см. Найдите длину отрезка \(MK\).
...
**С21.** В четырёхугольнике \(ABCD\) выполнено \(AB=BC\) и \(AD=DC\). Объясните, почему диагональ \(BD\) является серединным перпендикуляром к диагонали \(AC\).
...
**С24.** Прямая \(a\) пересекает серединный перпендикуляр к отрезку \(AB\) в точке \(M\). Докажите, что \(MA=MB\). Укажите, каким геометрическим местом точек является множество всех точек, равноудалённых от \(A\) и \(B\).
...
**С33.** Точки $A$ и $B$ расположены по одну сторону от прямой $a$. Серединный перпендикуляр к отрезку $AB$ пересекает прямую $a$ в точке $M$. Докажите, что $MA=MB$.
