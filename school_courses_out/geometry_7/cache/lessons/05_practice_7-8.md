...
-->
![Круг с центром O, радиусами OA, OB и хордой AB](figures/05_01_760344d09d.png)

*Круг с центром O, радиусами OA, OB и хордой AB*



**С5.** На окружности с центром $O$ точки $A$ и $B$ являются концами диаметра. Точка $C$ лежит на одной из дуг $AB$, а точка $D$ — на другой дуге $AB$. Назовите две дуги, на которые точки $A$ и $B$ разбивают окружность, и укажите, какие из этих дуг являются полуокружностями.
...
-->
![Отрезок AB с точкой C](figures/05_02_71c9a65c23.png)
...
-->
![Окружность с диаметром AD и хордами AB, BC, CD](figures/05_03_e5cfe8b449.png)

*Окружность с диаметром AD и хордами AB, BC, CD*
...
**С13.** Окружность с центром $O$ проходит через точки $A$, $B$, $C$ и $D$. Точки $A$ и $D$ являются концами диаметра. На рисунке проведены радиусы $OA$, $OB$, $OC$, $OD$ и все отрезки, соединяющие пары точек $A$, $B$, $C$, $D$. Назовите все проведённые радиусы, все проведённые хорды и диаметр. Укажите любые три различные дуги этой окружности.
